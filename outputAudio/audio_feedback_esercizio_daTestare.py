...
class OutputCorrezioneEsercizio:
  ...
  #funzione che si occupa del timer che va da tempo a 0 durante la fase di correzione esercizio
  def outputTimer(self, tempo):
    ...
    self.correttezzaMedia = correttezzaMedia / n_feedBack
  ...
  def feedback_movimento_notify(self, sensore, percentualeCorrettezza):
    ...
    self.correttezzaMedia += percentualeCorrettezza
    self.n_feedBack += 1